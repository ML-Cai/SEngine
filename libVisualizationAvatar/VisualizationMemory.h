#ifndef VISUALIZATIONMEMORY_H
#define VISUALIZATIONMEMORY_H
/* ------------------------------------------------------------------ */
...
namespace MMDCppDev {
    ...
    */
     ...
     *                   BDEF 2,
     *                   BDEF 4,  The deform function is under constructed.
    ...
    */
    struct MaterialUnitContext {
        ...
        unsigned char   EnvironmentBlendMode;
    ...
    */
    ...
    struct BoneUnitContext {
       ...
       // struct PMX_IKInformation BoneType_0x2000_IK;
    };
    ...
    struct VisualizationMemoryContext {
        unsigned int mID;
    ...
    public:
        //VisualizationMemory();
        struct VisualizationMemoryContext *create(struct PolygonModeleXtendedContext *srcPMX, unsigned int mElements);
        struct VisualizationMemoryContext *create(struct PolygonModelDataContext *srcPMD, unsigned int mElements);
        void release(struct VisualizationMemoryContext *srcVM);

    private :
        struct VisualizationMemoryContext *vMemoryCtx;
